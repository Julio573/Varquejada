...
![Interface do Sistema](assets/screenshots/main_interface.png)
...
Para iniciar a interface principal do sistema:
...
- **Abrir Vídeo:** Selecione um arquivo `.mp4` ou `.avi` para análise.
- **Play/Pause:** Controle a reprodução do vídeo.
- **Avançar/Retroceder:** Botões de precisão para análise detalhada do momento da queda.
- **Lock Lane:** Trava a detecção da faixa para análise de validade.
