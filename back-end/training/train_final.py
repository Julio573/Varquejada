...
def train_final():
    ...
    # Caminhos
    checkpoint_path = os.path.join(project_root, 'runs', 'detect', 'varquejada_yolo11_final', 'weights', 'last.pt')
    base_model_path = os.path.join(project_root, 'runs', 'detect', 'varquejada_yolo11_pro-2', 'weights', 'best.pt')
